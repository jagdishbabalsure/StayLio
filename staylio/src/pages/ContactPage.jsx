...
const ContactPage = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: 'Visit Us',
      details: '123 Business Park, Sector 18, Gurugram, Haryana 122015',
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-md font-semibold transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Visit our office in Gurugram for in-person assistance
            </p>
          </div>
